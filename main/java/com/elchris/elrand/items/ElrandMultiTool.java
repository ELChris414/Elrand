...
public class ElrandMultiTool extends ItemPickaxe{

	public ElrandMultiTool(ToolMaterial material) {
		super(material);
	}
	...
	private static Set effectiveAgainst = Sets.newHashSet(new Block[] {
		    ...
		    Blocks.chest, Blocks.pumpkin, Blocks.lit_pumpkin, ElrandBlocks.elrand_workstation_block, Blocks.leaves, Blocks.leaves2});
